...
insert into tb_prod(nome, ano, peso, preco, cor) values ("accc", 2018, 123.00, 100.00, "preto");
insert into tb_prod(nome, ano, peso, preco, cor) values ("accCac", 2018, 123.00, 2.00, "preto");
insert into tb_prod(nome, ano, peso, preco, cor) values ("cca", 2018, 123.00, 2.00, "preto");
